                        ...
                        <div class="swiper-slide banner banner-fixed intro-slide intro-slide1"
                            ...
                            <div class="container">
                                <figure class="slide-image floating-item slide-animate" data-animation-options="{
                                    ...
                                    <img src="{{ isset($item->image) ? route('image-show') . '?image=' . $item->image->path : asset('images/no-img.jpg') }}" alt="Ski" width="729"
                                        height="570" />
                                </figure>
                                <div class="banner-content text-right y-50 ml-auto">
                                    ...
                                    }">{{ $item->category->parent->title . ' - ' .$item->category->title}}</h5>
            ...
            <div class="container">
                ...
                <div class="swiper-container swiper-theme product-deals-wrapper appear-animate mb-7"
                    ...
                    <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-2">
                        @foreach($data['product_new_deals'] as $item)
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="{{ route('product_detail', ['id' => $item['id']]) }}">
                                        ...
                                        <!-- <img src="{{asset('front/images/demos/demo2/products/1-1-2.jpg')}}" alt="Product"
                                            width="300" height="338"> -->
                                    </a>
                                ...
                                <div class="product-details">
                                    <h4 class="product-name"><a href="{{ route('product_detail', ['id' => $item['id']]) }}">{{$item['title']}}</a></h4>
                                    <div class="ratings-container">
                                        <div class="ratings-full">
                                            <span class="ratings" style="width: {{$item['rating'] * 20}}%;"></span>
                                            <span class="tooltiptext tooltip-top"></span>
                                        </div>
                                        <a href="{{ route('product_detail', ['id' => $item['id']]) }}" class="rating-reviews">({{ $item['rating_count'] }} Reviews)</a>
                                    </div>
                ...
                <div class="swiper-container swiper-theme product-deals-wrapper appear-animate mb-7"
                    ...
                    <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-2">
                    @foreach($data['top_rating'] as $item)
                        <div class="swiper-slide product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="{{ route('product_detail', ['id' => $item['id']]) }}">
