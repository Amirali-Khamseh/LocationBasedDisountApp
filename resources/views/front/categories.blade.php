                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a  href="/product-detail/{{$item->id}}">
                                                <img src="{{ isset($item->image) ? route('image-show') . '?image=' . $item->image->path : asset('images/no-img.jpg') }}" alt="Product" width="300"
                                                    height="338" />
                                            </a>
            ...
            <div class="dropdown-box">
                <div class="products">
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="#">
                                <img src="{{asset('front/images/cart/product-1.jpg')}}" alt="product" height="84" width="94" />
                            </a>
                        </figure>
                    ...
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="#">
                                <img src="{{asset('front/images/cart/product-2.jpg')}}" alt="product" width="84" height="94" />
                            </a>
                        </figure>
                        <button class="btn btn-link btn-close" aria-label="button">
                            <i class="fas fa-times"></i>
                        ...
                        <div class="swiper-wrapper row cols-1 gutter-no">
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front/images/products/popup/1-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front/images/products/popup/1-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front/images/products/popup/2-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front/images/products/popup/2-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front/images/products/popup/3-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front/images/products/popup/3-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('front/images/products/popup/4-440x494.jpg')}}"
                                        data-zoom-image="{{asset('front/images/products/popup/4-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                        ...
                        <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('front/images/products/popup/1-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('front/images/products/popup/2-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('front/images/products/popup/3-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('front/images/products/popup/4-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                        </div>
                        <button class="swiper-button-next"></button>
            ...
            <div class="col-md-6 overflow-hidden p-relative">
                <div class="product-details scrollable pl-0">
                    ...
                    <div class="product-bm-wrapper">
                        <figure class="brand">
                            <img src="{{asset('front/images/products/brand/brand-1.jpg')}}" alt="Brand" width="102" height="48" />
                        </figure>
...
<script>
    ...
    //         var url = '/categories/{{ $data['cat_id'] }}?min=' + min + '&max=' + max;
