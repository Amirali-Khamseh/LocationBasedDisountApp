...
<main class="main">
            ...
            <div class="container">
                ...
                <div class="swiper-container swiper-theme product-deals-wrapper appear-animate mb-7"
                    ...
                    <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-2">
                    <?php $__currentLoopData = $data['top_rating']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide product-wrap">
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="<?php echo e(route('product_detail', ['id' => $item['id']])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\project_1\resources\views/front/index.blade.php ENDPATH**/ ?>