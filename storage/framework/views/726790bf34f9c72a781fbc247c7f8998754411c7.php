...
<form autocomplete="off" method="post" enctype="multipart/form-data" action="<?php echo e(route('store_product')); ?>">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <input type="text" name="discount_percent" class="form-control" id="discount_percent" placeholder="Enter Percentage of the discount !!!" value="<?php echo e(old('discount_percent')); ?>">
                </div>
            </div>
            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\project_1\resources\views/front/user/product_create.blade.php ENDPATH**/ ?>