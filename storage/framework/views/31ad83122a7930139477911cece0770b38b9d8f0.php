...
<div class="page-content">
    <div class="container">
        ...
        <table class="shop-table wishlist-table">
            ...
            <tbody>
                <?php $__currentLoopData = $data['wishlist']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="item-<?php echo e($item->id); ?>">
                    <td class="product-thumbnail">
                        <div class="p-relative">
                            <a href="product-default.html">
                                <figure>
                                    <img src="<?php echo e(isset($item->product->image) ? route('image-show') . '?image=' . $item->product->image->path : asset('images/no-img.jpg')); ?>" alt="product" width="300"
                                        height="338">
                                </figure>
                            </a>
                            <button type="button" onclick="removeFromWishlist(<?php echo e($item->id); ?>)" class="btn btn-close"><i
                    ...
                    <?php if($item->product->discount_percent > 0): ?>
                    <div class="product-price">
                        <?php echo e($item->product->price - ($item->product->discount_percent / 100) * $item->product->price); ?>  <del><?php echo e($item->product->price); ?></del><span class="discount_percent">%<?php echo e($item->product->discount_percent); ?></span>
                    </div>
                    <?php else: ?>
                    <div class="product-price">
...
<script>
    ...
    // var html = `<i class='w-icon-angle-left'></i><div class='parent-pop_up'>${html_data}</div><i class='w-icon-angle-right'></i>`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pixyboy\Desktop\laravel\project\resources\views/front/user/wishlist.blade.php ENDPATH**/ ?>